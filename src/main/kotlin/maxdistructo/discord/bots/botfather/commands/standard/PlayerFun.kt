...
object PlayerFun //Additions Ideas: Shoot,Stab,Fake mute
{
    ...
    fun onSlapCommand(message: Message, mentioned: Member): String {
        return if (mentioned.user !== message.jda.selfUser) {
            ...
            message.jda.selfUser.name +" has slapped you " + message.author + " :clap:"
        }
    }
    ...
    fun onTntCommand(message: Message, mentioned: Member): String {
        return if (mentioned.user !== message.jda.selfUser) {
            ...
            message.jda.selfUser.toString() + " has blown " + message.author + " up using TNT! :boom:"
        }
    }
    ...
    fun onMuteCommand(message: Message, mentioned: Member): String {
    ...
    fun onXpCommand(mentioned: Member): String {
